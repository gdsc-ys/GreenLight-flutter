...
class RealGroupView extends StatefulWidget {
  const RealGroupView({super.key});

  @override
  State<RealGroupView> createState() => _RealGroupViewState();
}

class _RealGroupViewState extends State<RealGroupView> {
      ...
      return Container(
          ...
          child: Container(
            ...
            child: Column(
              children: [
                Container(
                  margin: EdgeInsets.only(right: 120, bottom: 70),
                  child: Text(group_users[index][0], style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700),),
                ),
                Row(
                    ...
                    Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text(group_users[index][1], style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700),),
                          ),
                          Container(
                            margin: EdgeInsets.only(bottom: 10),
                            child: Text(' steps', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400),),
                          ),
                        ]
                    ),
                    Container(
                      margin: EdgeInsets.only(right: 10, bottom: 10),
                      child: Text("/ 10000 steps", style: TextStyle(fontSize: 10, fontWeight: FontWeight.w400, color: Color(0xffA3A3A3)),),
                    ),
                  ],
                ),
                Row(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Text((ratio*100).round().toString()+"%", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400),),
                    ),
                    Container(
                      margin: EdgeInsets.only(left: 40, top: 5),
                      child: Text((100 - ratio*100).round().toString()+"%", style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400),),
                    )
                  ],
                ),
              ],
          ...
          child: Container(
            ...
            child: Column(
              children: [
                Container(
                  margin: EdgeInsets.only(right: 120, bottom: 70),
                  child: Text(group_users[index][0], style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: Colors.white),),
                ),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                    Row(
                        ...
                        children: [
                          Container(
                            margin: EdgeInsets.only(left: 10, bottom: 10),
                            child: Text(group_users[index][1], style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: Colors.white),),
                          ),
                          Container(
                            margin: EdgeInsets.only(bottom: 10),
                            child: Text(' steps', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w400, color: Colors.white),),
                          ),
                        ]
                    ),
                    Container(
                      margin: EdgeInsets.only(right: 10, bottom: 10),
                      child: Text("/ 10000 steps", style: TextStyle(fontSize: 10, fontWeight: FontWeight.w400, color: Colors.white),),
                    ),
                  ],
                ),
                Row(
                ...
                Row(
                  ...
                  children: [
                    Container(
                      margin: EdgeInsets.only(right: 40, top: 5),
                      child: Text((ratio*100).round().toString()+"%",
                        style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: Colors.white),
                      ),
                    ),
                    Container(
                      margin: EdgeInsets.only(left: 40, top: 5),
                      child: Text((100 - ratio*100).round().toString()+"%",
                        style: TextStyle(fontSize: 12, fontWeight: FontWeight.w700, color: Colors.white),),
                    )
                  ],
                ),
